                ...
                <div class="card-body">
					<div class="container">
						...
						<table class="table table-striped">
							...
							<!--	<td>
									<a href="{{action('PostController2@edit', $passport->id)}}" class="btn btn-warning">Edit</a>
								</td>
								<td>
									<form action="{{action('PostController2@destroy', $passport->id)}}" method="post">
										@csrf
					 ...
					 <!--<a href="{{action('PostController2@create')}}" class="btn btn-success">Create New</a>-->
					</div>
